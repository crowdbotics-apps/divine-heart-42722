"""
Django settings for divine_heart_42722 project.
...
ROOT_URLCONF = 'divine_heart_42722.urls'
...
WSGI_APPLICATION = 'divine_heart_42722.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "divine_heart_42722 API",
    "DESCRIPTION": "API documentation for divine_heart_42722 App",
    "VERSION": "v1",
}
